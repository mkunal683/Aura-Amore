    ...
    function loginSignup(){
        for(let i=0;i<localStorage.length;i++){
            ...
            if(dataFetched.logined==true){
                document.getElementById('login-signup').href = '../ProfilePage/profile.html'
                document.getElementById('login-signup').innerHTML =`<i class="fa fa-user"></i> ${dataFetched.name}`
            }
        }
    }
